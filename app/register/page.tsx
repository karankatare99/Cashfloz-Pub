...
export default function RegisterPage() {
  return (
    ...
    <div className="min-h-screen bg-[#0A0A0F] flex flex-col items-center justify-center font-inter px-6 relative overflow-hidden selection:bg-[#E8602C]/30 selection:text-white">
       ...
       {/* [CASHFLOZ UI] — Visual Effects: Ambient Ember glow matching the login page */}
       ...
       <motion.div
         ...
         transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1], delay: 0.05 }} // Custom spring-like easing
             ...
             <CardContent className="px-8 pb-10 space-y-8">
                ...
                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="space-y-2">
                     <label className="text-[13px] text-[#F5EDD6]/70 font-inter font-medium tracking-wide">Full Name</label>
                     <FocusRingInput type="text" placeholder="Satoshi Nakamoto" />
                  </div>
                  <div className="space-y-2">
                  ...
                  {/* [CASHFLOZ UI] — Typography & Colors: Adjusted checkbox styling and Inter text */}
                  <div className="flex items-start gap-3 pt-2">
                    <input type="checkbox" id="terms" className="mt-1 w-4 h-4 rounded border-white/[0.15] bg-white/[0.03] accent-[#E8602C] focus:ring-[#E8602C] focus:ring-offset-0 focus:ring-offset-transparent cursor-pointer transition-colors" />
                    <label htmlFor="terms" className="text-[13px] text-[#F5EDD6]/60 font-inter leading-relaxed cursor-pointer select-none">
                      I agree to the <a href="#" className="text-[#F5EDD6] hover:text-[#E8602C] transition-colors underline underline-offset-2 decoration-white/20 hover:decoration-[#E8602C]/50">Terms of Service</a> and <a href="#" className="text-[#F5EDD6] hover:text-[#E8602C] transition-colors underline underline-offset-2 decoration-white/20 hover:decoration-[#E8602C]/50">Privacy Policy</a>
                    </label>
                  </div>
                  
                  {/* [CASHFLOZ UI] — Visual Effects: Primary button glow and scale interaction */}
                  <Button 
                    className="w-full h-12 mt-4 bg-[#E8602C] text-white text-[15px] font-space-grotesk font-semibold tracking-wide rounded-xl shadow-[0_0_20px_rgba(232,96,44,0.15)] hover:shadow-[0_0_24px_rgba(232,96,44,0.35)] hover:bg-[#E8602C]/90 hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-200 border-none"
                  >
                     SIGN UP
                  </Button>
                </form>
